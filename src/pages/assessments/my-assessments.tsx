...
function MyAssessments () {
  ...
  const [newHieght, setNewHieght] = React.useState(height);
  React.useEffect(() => {
    setNewHieght(height)
  }, [height]);
  ...
  return (
    <>
            ...
            <div className="flex items-center">
              <div className="flex items-center ms-3">
                <div className="flex items-center">
                  ...
                  <p className="text-sm font-semibold text-gray-900 dark:text-white ml-3" role="none">
                    Neil Sims
                  </p>
                </div>
          ...
          <ul className="space-y-2 font-medium">
            <li className="bg-[#FFEFDF] flex justify-center">
              <a href="#" className="flex items-center py-3 text-[#e4a76f] rounded-lg dark:text-white group">
                <svg className="flex-shrink-0 w-6 h-6 text-[#e4a76f] transition duration-75 dark:text-[#e4a76f] group-hover:text-[#e4a76f] dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                  <path d="M6.143 0H1.857A1.857 1.857 0 0 0 0 1.857v4.286C0 7.169.831 8 1.857 8h4.286A1.857 1.857 0 0 0 8 6.143V1.857A1.857 1.857 0 0 0 6.143 0Zm10 0h-4.286A1.857 1.857 0 0 0 10 1.857v4.286C10 7.169 10.831 8 11.857 8h4.286A1.857 1.857 0 0 0 18 6.143V1.857A1.857 1.857 0 0 0 16.143 0Zm-10 10H1.857A1.857 1.857 0 0 0 0 11.857v4.286C0 17.169.831 18 1.857 18h4.286A1.857 1.857 0 0 0 8 16.143v-4.286A1.857 1.857 0 0 0 6.143 10Zm10 0h-4.286A1.857 1.857 0 0 0 10 11.857v4.286c0 1.026.831 1.857 1.857 1.857h4.286A1.857 1.857 0 0 0 18 16.143v-4.286A1.857 1.857 0 0 0 16.143 10Z" />
                </svg>
              </a>
            </li>
            <li className="flex justify-center">
              <a href="#" className="flex items-center py-3 text-[#cccccc] rounded-lg dark:text-white group">
                <svg className="flex-shrink-0 w-6 h-6 text-[#cccccc] transition duration-75 dark:text-[#cccccc] group-hover:text-[#cccccc] dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
      ...
      <div className="sm:ml-16">
        <div id="middle-section" className={ `mt-14 border-t-4 border-l-4 border-gray-200 rounded-tl-xl bg-[#F9F7F0] overflow-y-scroll` }>
          <div className="p-12">
            ...
            { [1, 2, 3, 4, 5].map((item) => (
              <div key={ item } className="flex flex-wrap items-center justify-around mb-6 rounded-2xl bg-white">
