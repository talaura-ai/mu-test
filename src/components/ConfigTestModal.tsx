...
export default function TestDeviceConfigModal ({ cameraChecking, audioChecking, networkChecking, onClose, checkSpeed, speedLaoding }: any) {
        ...
        <div className="relative w-full my-6 mx-auto max-w-lg">
          <div className="border-0 rounded-xl shadow-lg relative flex flex-col w-full bg-[#F9F7F0] outline-none focus:outline-none px-6">
            ...
            <div className="flex items-center justify-center px-6 pb-6">
              <button onClick={ () => { onClose() } } type="button" className={ `font-sansation text-white bg-[#CC8448] hover:bg-[#CC8448]/80 focus:ring-4 focus:outline-none tracking-wide focus:ring-[#CC8448]/50 font-medium rounded-lg text-md px-12 py-2.5 text-center inline-flex items-center` }>
                Okay
              </button>
            </div>
          </div>
