    ...
    <>
      <div className="px-3 flex-auto">
        <div className="flex flex-col px-6 py-4 font-sansation">
          ...
          <span className="text-[18px] font-semibold text-[#7A8A94] py-1">
            2. <span className=" text-black text-[18px] font-medium">The test consists of a varying number of questions, typically around 10-15. The exact number may change depending on your responses.</span>
          </span>
          <span className="text-[18px] font-semibold text-[#7A8A94] py-1">
          ...
          <span className="text-[18px] font-semibold text-[#7A8A94] py-1">
            11. <span className=" text-black text-[18px] font-medium">Sharing your screen or any part of your screen is strictly prohibited during the test.</span>
          </span>
          <span className="text-[18px] font-semibold text-[#7A8A94] py-1">
          ...
          <span className="text-[18px] font-semibold text-[#7A8A94] py-1">
            16. <span className=" text-black text-[18px] font-medium">If you end the test, you will not be able to restart or reopen it. Ensure you are ready and have enough time before beginning the test</span>
          </span>
