    ...
    <>
      <div className="px-3 flex-auto">
        <div className="flex flex-col px-6 py-4 font-sansation">
          ...
          <span className="text-[20px] font-semibold text-[#7A8A94] py-1">
            2. <span className=" text-black text-[20px] font-medium">There are { test?.noOfQuestions * 1 || 0 } questions in this test.</span>
          </span>
          <span className="text-[20px] font-semibold text-[#7A8A94] py-1">
          ...
          <span className="text-[20px] font-semibold text-[#7A8A94] py-1">
            6. <span className=" text-black text-[20px] font-medium">Each question will be narrated by the AI. The questions will not be repeated, so make sure to listen attentively the first time.</span>
          </span>
          <span className="text-[20px] font-semibold text-[#7A8A94] py-1">
            7. <span className=" text-black text-[20px] font-medium">Type your answer in the provided text editor. Ensure that your answers are accurate and clearly written</span>
          </span>
          <span className="text-[20px] font-semibold text-[#7A8A94] py-1">
          ...
          <span className="text-[20px] font-semibold text-[#7A8A94] py-1">
            11. <span className=" text-black text-[20px] font-medium">Sharing your screen or any part of your screen is strictly prohibited during the quiz.</span>
          </span>
          <span className="text-[20px] font-semibold text-[#7A8A94] py-1">
