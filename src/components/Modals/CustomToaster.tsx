...
const CustomToaster = ({ message }: any) => {
  return (
    <div className="flex items-center justify-center  w-full absolute top-28 animate-slide-down">
      <div
        id="toast-warning"
      ...
      >
        ...
        <button
          type="button"
          className="ms-auto -mx-1.5 -my-1.5 bg-transparent text-gray-400 border-2 border-gray-400 rounded-full   p-1  inline-flex items-center justify-center h-6 w-6"
