...
const SettingsListItem: React.FC<SettingsListItemProps> = ({ fontSize, selectedOption, handleFontSizeChange }) => {
	return (
		<li className='relative flex h-8 cursor-pointer select-none py-1.5 pl-2 text-label-2 hover:bg-dark-fill-3 rounded-lg'>
			<div
			...
			<span
				className={`text-blue flex items-center pr-2 ${
