          ...
          <div className="border-0 rounded-3xl shadow-md relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="flex items-center justify-between px-6 pb-6 gap-4">
              <button
                ...
                type="button"
                className="text-white ml-2 bg-[#CC8448] font-medium font-sansation rounded-md text-lg w-40 py-2.5 text-center inline-flex items-center justify-center"
              >
                Start
              </button>
              <button
                ...
                type="button"
                className="text-[#7A8A94] border-[#CCC] border mr-2 font-medium font-sansation rounded-md text-lg w-40 py-2.5 text-center inline-flex items-center justify-center"
              >
                Cancel
              </button>
            </div>
